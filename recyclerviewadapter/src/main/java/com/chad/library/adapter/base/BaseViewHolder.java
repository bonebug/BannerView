...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    private final LinkedHashSet<Integer> childClickViewIds;//Item子view点击事件集合

    private final LinkedHashSet<Integer> itemChildLongClickViewIds;//Item子view长点击事件集合
     ...
     * <p>
     * or if you can use  recyclerView.addOnItemTouch(listerer)  we also support this menthod
     */
